 ...
 * CusttableFixture
 */
class CusttableFixture extends TestFixture
{
    /**
     * Table name
     *
    ...
    public $fields = [
        ...
        'tableNo' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_constraints' => [
            ...
            'food_id' => ['type' => 'foreign', 'columns' => ['food_id'], 'references' => ['food', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'qty' => 1,
                'price' => 1.5,
                'created' => '2019-12-03 09:31:09',
                'modified' => '2019-12-03 09:31:09'
            ],
        ];
        parent::init();
    }
